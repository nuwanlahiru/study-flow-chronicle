...
const Index = () => {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-16rem)]">
          ...
          <div className="grid gap-4 lg:grid-cols-[1fr_400px] lg:gap-8 xl:grid-cols-[1fr_500px]">
            <div className="flex flex-col justify-center space-y-3">
              <div className="space-y-1">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl my-0 lg:text-6xl">
            ...
            <div className="flex items-center justify-center">
              <div className="relative h-[300px] w-[300px] md:h-[350px] md:w-[350px] lg:h-[400px] lg:w-[400px] rounded-full bg-studypurple-100/50 flex items-center justify-center">
                <div className="absolute inset-0 flex items-center justify-center">
                  <BookOpen className="h-32 w-32 text-studypurple-400" />
                </div>
                <div className="absolute top-10 right-10">
                  <div className="h-14 w-14 rounded-full bg-studypurple-200 flex items-center justify-center animate-bounce">
                    <Calendar className="h-7 w-7 text-studypurple-500" />
                  </div>
                </div>
                <div className="absolute bottom-20 left-10">
                  <div className="h-14 w-14 rounded-full bg-studypurple-200 flex items-center justify-center animate-bounce" style={{
                    animationDelay: '0.2s'
                  }}>
                    <BarChart3 className="h-7 w-7 text-studypurple-500" />
                  </div>
                </div>
                <div className="absolute bottom-10 right-20">
                  <div className="h-14 w-14 rounded-full bg-studypurple-200 flex items-center justify-center animate-bounce" style={{
                    ...
                    <Activity className="h-7 w-7 text-studypurple-500" />
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Features Section */}
      <section className="w-full py-8 md:py-12 bg-studypurple-50">
        <div className="container px-4 md:px-6">
