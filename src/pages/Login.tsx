...
import { BookOpen, LogIn, Brain, Sparkles, Lock, ChevronRight, Mail } from "lucide-react";
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message?.includes("Invalid login")) {
        toast("Don't have an account? Please sign up", {
          action: {
            label: "Sign Up",
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-white via-studypurple-50 to-blue-50">
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="relative bg-white/80 backdrop-blur-md rounded-2xl shadow-xl overflow-hidden border border-white/50 hover:shadow-2xl transition-all duration-500">
          ...
          <div className="bg-gradient-to-r from-studypurple-600 to-blue-600 p-6 text-white">
            ...
            <p className="text-white/80">Sign in to continue your productivity journey</p>
          </div>
          ...
          <div className="p-6 space-y-5">
            {!showEmailForm ? (
              <>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex items-center">
                      ...
                      />
                      <span className="font-medium">{loading ? "Signing in..." : "Continue with Facebook"}</span>
                ...
                >
                  <Button 
                    ...
                    className="w-full bg-gradient-to-r from-studypurple-500 to-blue-500 hover:from-studypurple-600 hover:to-blue-600 text-white flex items-center justify-center py-6 transition-all duration-300"
                    size="lg"
                  >
                    <div className="relative flex items-center">
              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                ...
                <div className="flex flex-col space-y-2">
                  <Button 
                    type="submit"
                    className="w-full bg-gradient-to-r from-studypurple-500 to-blue-500 hover:from-studypurple-600 hover:to-blue-600"
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-500">
                Don't have an account? <Link to="/signup" className="text-studypurple-600 font-medium hover:text-studypurple-700 transition-colors">Sign up</Link>
              </p>
            </div>
          </div>
          ...
          <div className="absolute top-0 right-0 h-16 w-16 bg-gradient-to-br from-studypurple-400/20 to-blue-400/20 rounded-bl-3xl" />
          <div className="absolute bottom-0 left-0 h-16 w-16 bg-gradient-to-tr from-studypurple-400/20 to-blue-400/20 rounded-tr-3xl" />
        </div>
      </div>
    </div>
  );
